...
object JmapMapper {
    ...
    fun mapEmail(
        ...
        return MessageEntity(
            ...
            fromAddress = fromList.firstOrNull()?.optString("email")?.takeIf { it != "null" } ?: "",
            fromDisplayName = fromList.firstOrNull()?.optString("name")?.takeIf { it != "null" && it.isNotBlank() },
            toAddresses = toList.joinToString(", ") { it.optString("email").takeIf { v -> v != "null" } ?: "" },
